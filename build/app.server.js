...
/***/ function(module, exports, __webpack_require__) {
	...
	var BeforeInputEventPlugin = __webpack_require__(5);
	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _axios2['default'].get('http://reactjs102.herokuapp.com/products').then(function (response) {
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('img', { src: data[0].image }),
	                productItems
	            );
	        }
	    }]);
